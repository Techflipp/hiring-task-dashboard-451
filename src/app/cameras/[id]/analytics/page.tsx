// import { getDemographicsResults } from '@/lib/getDemographicsResults';
// import { notFound } from 'next/navigation';

// export default async function AnalyticsPage({ params }: { params: { id: string } }) {
//   const results = await getDemographicsResults(params.id);
//   console.log(results)
...
//   return (
//     <div className="p-6">
//       <h1 className="text-xl font-bold mb-4">Demographics Analytics</h1>
//       <pre className="text-sm bg-gray-100 p-4 rounded">{JSON.stringify(results, null, 2)}</pre>
//     </div>
//   );
// }
...
import { Users, Eye, Calendar, Settings, TrendingUp, Filter, Download, RefreshCw } from 'lucide-react';
 ...
 const params = useParams();  
  ...
  const formatChartData = (distribution) => {
    return Object.entries(distribution).map(([key, value]) => ({
      ...
      value: value,
      percentage: data ? ((value / data.analytics.total_count) * 100).toFixed(1) : 0
    }));
  };
  ...
  const MetricSelector = ({ metrics, selected, onSelect }) => (
